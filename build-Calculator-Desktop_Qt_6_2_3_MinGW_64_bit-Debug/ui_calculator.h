...
"}"));
        ...
        gridLayout->addWidget(Equals, 7, 4, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(MemAdd, 5, 4, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(Subtract, 7, 3, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(Times, 5, 3, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(MemClear, 6, 4, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(ChangeSign, 7, 0, 1, 1);
...
"}"));
        ...
        gridLayout->addWidget(Clear, 3, 3, 1, 2);
